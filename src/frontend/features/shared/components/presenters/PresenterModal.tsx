"use client"
import { PresenterModalProps } from "@/frontend/features/shared/components/containers/ContainerModal"

export default function PresenterModal({ children, actions }: PresenterModalProps ) {
    return (
