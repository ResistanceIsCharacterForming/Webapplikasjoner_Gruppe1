   ...
   return (
      <main className="grid grid-cols-5 grid-rows-17 gap-0 bg-oldRose h-screen">
         ...
         <article className=" col-span-5 row-start-2 col-span-2 bg-oldRose flex h-100%">
            <button onClick={()=>listReports()} className={buttonstyle}> alle</button>
            <button onClick={()=>listReports("review")} className={buttonstyle}> anmeldelse</button>
            <button onClick={()=>listReports("User")} className={buttonstyle}> bruker</button>
            <button onClick={()=>listReports("libary")} className={buttonstyle}> bibliotek</button>
         </article>
