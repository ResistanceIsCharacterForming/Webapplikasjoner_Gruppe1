...
export const ReportsContainer = (props: { category: string }) => {
   ...
   // reads the prop to propery sett the reports that match with it 
   ...
   // gets a list of reports, and sett it in state to be acced later
   ...
   // makes a list of reports componets and setts it to showcase
